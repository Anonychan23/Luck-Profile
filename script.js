...
const SITE_DATA = {
  ...
  bio: "เป็นเรื่องปกติที่คนพบกันเพื่อจาก มนุษย์คนไทยแท้เจ้าบทกลอน",
  likes: "นอนหลับเต็มที่ ของหวานและเวลาแสนสงบ กลิ่นป่า ที่เป็นป่าจริง ๆ การวาดภาพ การสร้างงานศิลปะ ART",
  dislikes: "นอนน้อยจนถึงไม่พอ แมลงตัวใหญ่หลายขา เงาตะคุ่ม เสียงดังตอนที่เหม่อ",
  ...
  randomFacts: "แล้วแต่ อะไรก็ได้ คนไทยเป็นกันเองอยู่แล้ว",
  habits: "พูดน้อย เลือกจะพูดคนเดียวกับหัวไหล่ ใครว่าก็ดูเป็นมิตร แต่มักจะดูดุมากกว่าบ่อยครั้ง เพียงตาขีด ๆ ของเจ้าตัว ไม่มีเจตนาทำให้ใครกลัว มักจะเห็นชอบอยู่กับฮู้ดหนา ๆ ใส่หูฟังมีสายฟังเพลงบ่อย ๆ แต่หากมีใครทักทายก็จะตอบกลับไปอย่างเป็นมิตรเสมอ",
